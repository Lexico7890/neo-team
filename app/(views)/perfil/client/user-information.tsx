...
import { UserSchemaPlayer, UserSchemaReferee, type UserDataPlayer, type UserDataReferee } from '@/app/types/schema/user-schema'
...
const UserInformation = ({
  ...
  const updateUserData = () => {
    ...
    if (user.bird_date !== '') { user.bird_date !== null && new Date(user.bird_date) } else userData.dateBirth = new Date(`${month + 1}/${day}/${year}`)
        ...
        <div className="md:grid flex flex-col grid-cols-4 md:gap-8 gap-2 w-full">
          ...
          <div className="col-span-3 block lg:flex">
            <div className="w-full flex flex-col gap-8 items-center p-2">
              ...
              <div className="grid w-full max-w-sm items-center gap-1.5">
                <Label htmlFor="identityNumber">Numero de identificación</Label>
                <Input
                  type="number"
                  id="numberIdentity"
              ...
              <div className="grid w-full max-w-sm items-center gap-1.5">
                ...
                <Select
                  onValueChange={(value: any) => {
                    ...
                    const selectRol = items?.find((item) => item.id === value)
                    if (selectRol !== undefined) { setRolSelected(selectRol?.name) }
                  }}
                  value={userData.rol}
                >
