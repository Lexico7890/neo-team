  ...
  return (
    <div className={`${styles.container} flex flex-row justify-center p-10`}>
      <div className={styles.card}>
        ...
        />
        <Button variant={'outline'} className='dark:bg-black bg-white font-semibold text-lg'>Crear equipo</Button>
      </div>
      <div className={styles.card}>
        ...
        <Image
          ...
          className={`${styles.c3d}`}
        />
        <Button variant={'outline'} className='dark:bg-black bg-white font-semibold text-lg'>Buscar equipo</Button>
      </div>
    </div>
  )
}
